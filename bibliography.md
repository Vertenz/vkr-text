...
1. Егиазарян М. С. Анализ существующих приложений по ведению семейного бюджета / М. С. Егиазарян // Хроноэкономика. — 2020. — № 3 (24). — С. 110–117. — URL: https://cyberleninka.ru/article/n/analiz-suschestvuyuschih-prilozhenii-po-vedeniyu-semeynogo-byudzheta (дата обращения: 12.04.2026).
...
11. Docker Documentation [Электронный ресурс]. — URL: https://docs.docker.com (дата обращения: 12.04.2026).
...
15. PostgreSQL 16 Documentation [Электронный ресурс]. — URL: https://www.postgresql.org/docs/16/ (дата обращения: 12.04.2026).

16. RabbitMQ Documentation [Электронный ресурс]. — URL: https://www.rabbitmq.com/docs (дата обращения: 12.04.2026).

17. Splitwise — Split expenses with friends [Электронный ресурс]. — URL: https://www.splitwise.com (дата обращения: 12.04.2026).
...
21. CoinKeeper — Приложение для учёта расходов [Электронный ресурс]. — URL: https://about.coinkeeper.me/ (дата обращения: 12.04.2026).

22. Nginx Documentation [Электронный ресурс]. — URL: https://nginx.org/en/docs/ (дата обращения: 19.04.2026).

23. Alembic Documentation [Электронный ресурс]. — URL: https://alembic.sqlalchemy.org/en/latest/ (дата обращения: 19.04.2026).
